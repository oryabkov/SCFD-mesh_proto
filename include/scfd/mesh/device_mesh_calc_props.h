...
{
    FOR_EACH_FUNC_PARAMS_HELP(t_copy_deform_2_buf_func,
...
{
    FOR_EACH_FUNC_PARAMS_HELP(t_shepard_deform,
                  t_idx_field,  buffer_idx,
                  t_vec_field,  deform_vec_buffer,
...
struct t_move_nodes
{
    FOR_EACH_FUNC_PARAMS_HELP(t_move_nodes,
                  t_vec_field,  deform_vec)
...
__DEVICE_TAG__ real get_tetrahedron_volume(real tet_verteces[4][dim]){
    ...
    real tet_volume;
    tet_volume = sc_tr::abs(+tet_verteces[0][0]*(tet_verteces[1][1]*tet_verteces[2][2]-tet_verteces[2][1]*tet_verteces[1][2])
...
__DEVICE_TAG__ real volume_of_4_tetraheda_from_4_verteces_and_center(t_vec face_verteces[4], const t_vec &face_center, const t_vec &element_center){
...
void init_mesh_deform_shepard(const t_map_nodes &map_nodes, const t_cpu_mesh &cpu_mesh, 
...
void mesh_deform_shepard(const t_vec_field &deform_vec,
...
void copy_deform_2_cpu_mesh(const t_gpu_mesh    &gpu_mesh,
