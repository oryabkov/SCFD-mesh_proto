...
struct t_cubature_reference_max_pnts_n_tml
{
};

template<int max_order>
struct t_face_cubature_reference_max_pnts_n_tml
{
};
...
template<>
struct t_cubature_reference_max_pnts_n_tml<1>
{
...
template<>
struct t_cubature_reference_max_pnts_n_tml<2>
{
...
template<>
struct t_cubature_reference_max_pnts_n_tml<3>
{
...
/*template<>
struct t_cubature_reference_max_pnts_n_tml<4>
{
...
template<>
struct t_cubature_reference_max_pnts_n_tml<5>
{
	//static const int value = 14;	//for tetrahedron
...
template<>
struct t_cubature_reference_max_pnts_n_tml<6>
{
...
template<>
struct t_face_cubature_reference_max_pnts_n_tml<1>
{
...
template<>
struct t_face_cubature_reference_max_pnts_n_tml<2>
{
...
template<>
struct t_face_cubature_reference_max_pnts_n_tml<3>
{
...
template<>
struct t_face_cubature_reference_max_pnts_n_tml<4>
{
...
template<>
struct t_face_cubature_reference_max_pnts_n_tml<5>
{
...
struct t_elem_cubature_reference_tml
{
	typedef t_vec_tml<T,3>	t_vec;

	static const int max_pnts_n = t_cubature_reference_max_pnts_n_tml<max_order>::value;
	...
	void	__init_triangle()
	{
		...
		throw std::runtime_error("t_elem_cubature_reference_tml::__init_triangle : not supported order");
	...
	void	__init_quad()
	{
		...
		throw std::runtime_error("t_elem_cubature_reference_tml::__init_quad : not supported order");
	...
	void	__init_tetrahedron()
	{
		...
		throw std::runtime_error("t_elem_cubature_reference_tml::__init_tetrahedron : not supported order");
	...
	void	__init_hexahedron()
	{
		...
		throw std::runtime_error("t_elem_cubature_reference_tml::__init_hexahedron : not supported order");
	}
	void	__init_prism()
	{
		...
		throw std::runtime_error("t_elem_cubature_reference_tml::__init_prism : not supported order");

		//TODO
	}

	void	init_for_coords(const t_elem_cubature_reference_tml &q_ref, int elem_type,
...
template<int max_order, class T>
struct t_cubature_reference_tml
{
	typedef t_vec_tml<T,3>					t_vec;
	typedef t_elem_cubature_reference_tml<max_order,T>	t_elem_cubature;
