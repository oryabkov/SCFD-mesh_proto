...
#include <communication/t_serial_map.h>
#include <mesh/t_cpu_mesh_tml.h>
#include <mesh/t_gpu_mesh_tml.h>
#include <mesh/t_gpu_mesh_tml_init.h>
#include <postpro_output/gmsh_pos_output.h>

#define dim				3
typedef GPU_POISSON_SOLVER_SCALAR_TYPE	real;
typedef t_vec_tml<real,dim>		t_vec;
typedef t_cpu_mesh_tml<real>            t_cpu_mesh;
typedef t_serial_map			t_map;
typedef t_gpu_mesh_tml<real>		t_gpu_mesh;
